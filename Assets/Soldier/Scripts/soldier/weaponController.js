...
var aimSpeed : float = 10.0;
var accuracyLossMultiplier : float = 0; //0.5
...
//	}
	...
	crosshairScript.accuracyLoss = 0.6f;
	accuracyLoss = Mathf.Max(accuracyLoss, 1.0);
	var accuracy : float = 1 / accuracyLoss;
	gunSelectorScript.BroadcastMessage("SetAccuracy", 1, SendMessageOptions.DontRequireReceiver);
}
